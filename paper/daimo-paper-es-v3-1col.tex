% -----------------------------------------------------------
% Versión en UNA COLUMNA (formato de trabajo / borrador legible).
% — Clase: article 11pt A4, margen 2.5cm.
% — La versión Sage para submission SWJ es daimo-paper-es-v3.tex.
% — Contenido idéntico; sólo cambia el preámbulo y la maqueta.
% -----------------------------------------------------------
...
% En article plano no existe \keywords de Sage; lo definimos como macro local.
...
\title{DAIMO: un perfil de integración para activos de modelos de inteligencia artificial gobernados en espacios de datos}
...
\normalsize Departamento de Inteligencia Artificial, ETSI Informáticos\\
