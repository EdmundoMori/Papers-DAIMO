...
- Command: `sha256 of protected sources (after)`
- Started (UTC): 2026-09-06T12:06:27Z
- Finished (UTC): 2026-09-06T12:06:27Z
- Working-tree status (`git status -sb`): `## main...origin/main
 M daimo/docs/index-en.html
 M daimo/docs/ontology.jsonld
 M daimo/docs/ontology.nt
 M daimo/docs/ontology.owl
 M daimo/docs/provenance/provenance-en.html
 M daimo/docs/provenance/provenance-en.ttl
 D daimo/docs/sections/crossref-en.html
 D daimo/docs/sections/description-en.html
 D daimo/docs/sections/overview-en.html
 M daimo/docs/webvowl/data/ontology.json
 ...
 M docs/04-DAIMO-ISSUE-RESOLUTION.md
?? daimo/reports/checksums-protected-before.json
?? daimo/reports/checksums-protected-before.md
?? daimo/reports/execution-summary.json
?? daimo/reports/serialization-test-results.md
?? daimo/reports/structural-metrics.md
?? daimo/reports/widoco-generation.md
...
**El commit evaluado es `cd3c1ae0f8ad262fbbe899dd9b8b95db128becad`.** La coincidencia/diferencia es respecto de los checksums before tomados en ese HEAD (`daimo/reports/checksums-protected-before.json`).

---

## Comparison with checksums-protected-before.json

**Todos los checksums protegidos coinciden** con `checksums-protected-before.json`.
...
## Protected-file checksums (after)
